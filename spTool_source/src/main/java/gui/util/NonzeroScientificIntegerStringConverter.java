...
public class NonzeroScientificIntegerStringConverter extends StringConverter<Integer> {

  /*

  Note, this viewer is meant to be scientific.
  Only in the "human readable range between 1 and 9999", we want to keep standard notation.
  ...
  private static final Logger LOGGER = LogManager
      .getLogger(NonzeroScientificIntegerStringConverter.class.getName());
  ...
  public NonzeroScientificIntegerStringConverter() {
  ...
  public NonzeroScientificIntegerStringConverter(NF nfPLAIN, NF nfSCIENCE) {
