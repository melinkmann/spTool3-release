...
public class CreateSingleSubMethodDialog extends ChooseSingleFromListDialog<FxParamSet> {

  // Make smaller
  protected static final double PREF_WIDTH = 600;
  protected static final double PREF_HEIGHT = 500;

  public CreateSingleSubMethodDialog(FxParamSet[] values, FxEntryFactory<FxParamSet> factory) {
    this(Arrays.asList(values), factory);
  }

  public CreateSingleSubMethodDialog(List<FxParamSet> values, FxEntryFactory<FxParamSet> factory) {
