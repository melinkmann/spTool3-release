...
public enum NMPUnit implements Unit, Serializable {
  ...
  public static String getPrefix(NMPUnit u) {
    String prefix = "";
    if (u != null) {
      if (u.getUnit() instanceof MassUnit) {
        prefix = "Mass";
      } else if (u.getUnit() instanceof SizeUnit) {
        prefix = "Size";
      } else if (u.getUnit() instanceof MolarUnit) {
        prefix = "Mol";
      } else if (u.getUnit() instanceof IntensityUnit) {
        prefix = "Intensity";
      }
    }
    return prefix;
