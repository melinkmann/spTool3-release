...
public interface StatDataSet extends Serializable {
  ...
  String getLocationMeasure();

  String getSpreadMeasure();
  ...
  double calcDetectionLimit();

  double calcCriticalLimit();

  double calcLowerOutlierLimit();

  double calcPValue(double intensity);
