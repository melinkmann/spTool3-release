...
public class SingleColorSamplingLineShapeRenderer extends SamplingXYLineRenderer {

  private final Paint paint;
  private final BasicStroke stroke;
  private final Shape shape;

  public SingleColorSamplingLineShapeRenderer(Paint paint, BasicStroke stroke, Shape shape) {
    this.paint = paint;
    this.stroke = stroke;
    this.shape = shape;
  }

  public SingleColorSamplingLineShapeRenderer(ChartStyle style) {
