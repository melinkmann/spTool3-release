 ...
 * BoxAndWhiskerChartDemo1.java} program included in the JFreeChart Demo Collection:
 * <br><br>
 * <img src="../../../../../images/BoxAndWhiskerRendererSample.png" alt="BoxAndWhiskerRendererSample.png">
 */
public class CustomBoxAndWhiskerRenderer extends AbstractCategoryItemRenderer
   ...
   * Default constructor.
   */
  public CustomBoxAndWhiskerRenderer(List<Paint> paints, List<String> shortLabels) {
  ...
  public Paint lookupSeriesPaint(int series) {
    Paint paint = OkabeItoColors.BLACK.get();
    if (paints.size() > series) {
      paint = paints.get(series);
    }
    return paint;
  }
  ...
  /**
   * Initialises the renderer.  This method gets called once at the start of the process of drawing
   * a chart.
   *
    ...
    if (this.meanVisible) {
      ...
      if (xMean != null) {
        ...
        if ((xxMean > (dataArea.getMinX() - aRadius))
          ...
          Ellipse2D.Double avgEllipse = new Ellipse2D.Double(xxMean + subtract
              - aRadius, yy + aRadius + subtract, (aRadius - subtract) * 2,
              (aRadius - subtract) * 2);
          g2.fill(avgEllipse);
          g2.draw(avgEllipse);
        }
  ...
  public void drawVerticalItem(Graphics2D g2, CategoryItemRendererState state,
    ...
    if (yQ1 != null && yQ3 != null && yMax != null && yMin != null) {
      ...
      if (this.meanVisible) {
        ...
        yMean = bawDataset.getMedianValue(row, column);
        if (yMean != null) {
          ...
          if ((yyAverage > (dataArea.getMinY() - aRadius))
            ...
            Ellipse2D.Double avgEllipse = new Ellipse2D.Double(
                xx + aRadius + subtract, yyAverage - aRadius + subtract, (aRadius - subtract) * 2,
                (aRadius - subtract) * 2);
            g2.fill(avgEllipse);
            g2.draw(avgEllipse);
          }
    ...
    List<Outlier> customOutliers = new ArrayList<>();
    ...
    if (yOutliers != null) {
      for (int i = 0; i < yOutliers.size(); i++) {
        ...
        if (outlier > maxRegular.doubleValue()) {
          yyOutlier = rangeAxis.valueToJava2D(outlier, dataArea,
              location);
          customOutliers.add(new Outlier(xx + state.getBarWidth() / 2.0,
              yyOutlier, oRadius));
      ...
      Collections.sort(customOutliers);
  ...
  private void drawEllipse(Point2D point, double oRadius, Graphics2D g2) {
    double subtract = oRadius * 0.75;
    Ellipse2D dot = new Ellipse2D.Double(point.getX() + subtract + oRadius / 2,
        point.getY() + subtract, oRadius - subtract, oRadius - subtract);
    g2.draw(dot);
  }
