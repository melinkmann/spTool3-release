...
public class PathParameter extends AbstractParameter<String> implements Serializable,
    Parameter<String> {
  ...
  public PathParameter(String label,
      String explanation,
      String value,
  ...
  public Parameter<String> copyWithoutChildren() {
    Parameter<String> copy = new PathParameter(
        super.getLabel(),
  ...
  public void trySetValue(Parameter<?> par) {
    if (par instanceof PathParameter) {
      String val = ((PathParameter) par).getValue();
      setValue(val);
    }
  }
  ...
  public FxParameter<String> getObservableInstance() {
    ...
    return new PathFxParameter(this, formatter);
  }

  @Override
  public boolean isEquivalent(Parameter<?> other) {
    boolean equivalent = other instanceof PathParameter;
    // This is cast-safe :-)
    equivalent = equivalent && this.getValue().equals(((PathParameter) other).getValue());
    return equivalent;
  }
}