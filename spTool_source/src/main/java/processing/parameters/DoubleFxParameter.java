...
public class DoubleFxParameter extends AbstractFxParameter<Double> implements FxParameter<Double> {

  private static final Logger LOGGER = LogManager.getLogger(DoubleFxParameter.class);
  ...
  public DoubleFxParameter(Parameter<Double> plain, NF format, TextFormatter<Double> formatter) {
    super(plain);
    this.format = format;
