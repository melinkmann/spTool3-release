...
public class ParamSetterButtonDecoration<T extends Serializable> implements Decoration<T>, Serializable {
  ...
  private FxParameter<?> controlFxParameter;

  public ParamSetterButtonDecoration(String tooltip, String resource, Functional buttonFunction) {
  ...
  public Node getControl(FxParameter<T> fxParameter) {
    ...
    btn.setOnAction(e -> {
      ...
      if (controlFxParameter!=null){
        controlFxParameter.notifyItemChange(); // refresh
      }
    });
    return btn;
  }
