...
public class AlignFilterStartStopBundle implements ParamBundle {
  ...
  public AlignFilterStartStopBundle(SpawnControlParameter parent) {
    ...
    this.start = new DoubleParameter("Start",
        """
            Values below this number are rejected.
            Values above or equal to this number are kept""",
        5d,
        NF.D1C3,
    ...
    this.end = new DoubleParameter("End",
        """
            Values above this number are rejected.
            Values below or equal to this number are kept""",
        1E6,
        NF.D1C3,
        TextFormatterOption.ASSURE_POSITIVE_DOUBLE,
        false,
  ...
  public AlignFilterStartStopBundle(AlignFilterStartStopBundle elementBundle, SpawnControlParameter parent) {
    this.parentSpawnPar = parent;
  ...
  public ParamBundle copy(SpawnControlParameter newParent) {
    ParamBundle copy = new AlignFilterStartStopBundle(this, newParent);
    return copy;
  }
  ...
  private String wrapID(String id) {
    return id + "_in_" + ParamBundle.BUNDLE_ID_ALIGN_FILTER_START_STOP;
  }
